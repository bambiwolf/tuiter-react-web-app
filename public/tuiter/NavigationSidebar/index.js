const NavigationSidebar = () => {
   ...
   <div class="list-group">
     ...
     <a class="list-group-item" href="/"> <i class="fas fa-home"></i> Home</a>
     <a class="list-group-item" href="/explore"> <i class="fas fa-hashtag"></i> Explore</a>
     ...
     <a class="list-group-item" href="/profile"> <i class="fas fa-user"></i> Profile</a>
